...
- [ ] Each check shows pass or fail with a plain message (401 maps to scope hint, 404 to repo hint).
- [ ] Save kicks off the first full sync as a background job with progress state.
